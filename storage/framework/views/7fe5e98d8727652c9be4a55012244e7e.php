<?php $__env->startSection('content'); ?>
    <div class="card mt-4 mb-4 border-light shadow">
        ...
        <div class="card-header hstack gap-2">
            ...
            <span class="ms-auto">
                <a href="<?php echo e(route('user.create')); ?>" class="btn btn-dark btn-sm">Cadastrar</a>
            </span>
        </div>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <!-- Visualizar -->
                                <a href="<?php echo e(route('user.show', ['user' => $user->id])); ?>" class="btn btn-dark btn-sm">
                                ...
                                <!-- Editar -->
                                <a href="<?php echo e(route('user.edit', ['user' => $user->id])); ?>" class="btn btn-dark btn-sm">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
