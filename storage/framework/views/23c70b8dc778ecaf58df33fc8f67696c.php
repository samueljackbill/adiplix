...
<body>
        ...
        <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                ...
                <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                    <li><a href="<?php echo e(route('index.index')); ?>" class="nav-link px-2 text-white">Home</a></li>
                    <li><a href="<?php echo e(route('user.index')); ?>" class="nav-link px-2 text-white">Pessoas</a></li>
                    <li><a href="<?php echo e(route('task.index')); ?>" class="nav-link px-2 text-white">Tarefas</a></li>
                </ul>
    ...
    <script>
        function fetch_std() {
            $.ajax({
                url: "<?php echo e(route('index.records')); ?>",
                type: "GET",
                dataType: "json",
        ...
        function fetch(std, res) {
            $.ajax({
                url: "<?php echo e(route('students/records')); ?>",
                type: "GEt",
                data: {
                    std: std,
                    res: res
...
</html><?php /**PATH C:\xampp\htdocs\crud-laravel\resources\views/index/index.blade.php ENDPATH**/ ?>